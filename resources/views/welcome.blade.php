            ...
            <div class="section text-center section-landing">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <h5 class="description">PPuedes revisar nuestra relación completa de productos, comparar precios y realizar tus pedidos cuando estés seguro.</h5>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="info">
                                ...
                                <p>Todo pedido que realices será confirmado a travéss de una llamada. Si no confias en los pagos en linea, puedes pagar contra entrega el valor acordado.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info">
            ...
            <div class="section landing-section">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <h4 class="text-center description">Registrate ingresando tus datos básicos y podrás realizar tus pedidos a través de nuestro carrito de compra.</h4>
